...
class HomeLocalDataSourceImpl implements HomeLocalDataSource {
  ...
  Future<HomeEntity> getHomeData() async {
    try {
      ...
      final description = _sharedPreferences.getString(_descriptionKey) ?? 'This is your home screen';
      ...
      final lastUpdated = lastUpdatedString != null ? DateTime.parse(lastUpdatedString) : DateTime.now();
      ...
      return HomeModel(
        title: 'Welcome Home',
        description: 'This is your home screen',
        itemCount: 0,
  ...
  Future<void> saveHomeData(HomeEntity homeData) async {
    try {
      ...
      await _sharedPreferences.setString(_lastUpdatedKey, homeData.lastUpdated.toIso8601String());
    } catch (e) {
