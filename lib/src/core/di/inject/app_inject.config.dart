...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt $initGetIt({
    ...
    gh.lazySingleton<_i76.ComponentWatchItLogic>(
        () => _i76.ComponentWatchItLogic());
    gh.lazySingleton<_i1030.ComponentWatchItV2Logic>(
        () => _i1030.ComponentWatchItV2Logic());
    gh.lazySingleton<_i430.GetViewController>(() =>
        _i430.GetViewController(repository: gh<_i821.SampleCodeFakeApiImpl>()));
    gh.singleton<_i803.NetworkHelper>(
        () => _i803.NetworkHelper(gh<_i973.InternetConnectionChecker>()));
    return this;
  }
}
