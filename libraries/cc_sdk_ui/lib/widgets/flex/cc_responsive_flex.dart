...
class CcResponsiveFlex extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (screenType == ScreenType.mobile || screenType == ScreenType.smallMobile) {
      return Column(
  ...
  List<Widget> _buildSpacedChildren(double spacing, {bool isVertical = false, List<Widget>? widgets}) {
