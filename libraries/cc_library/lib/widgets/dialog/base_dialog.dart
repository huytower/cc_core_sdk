...
import 'package:cc_library/core/constants/cc_padding_params.dart';
import 'package:cc_library/core/theme/base_colors.dart';
import 'package:cc_library/widgets/dialog/action_btn_in_dialog.dart';
import 'package:cc_library/widgets/flex/cc_column_start.dart';
import 'package:cc_library/widgets/flex/cc_row_between.dart';
...
class BaseDialog extends StatelessWidget {
  ...
  Widget buildIconAlert() => when(variable: status, conditions: {
        DialogStatus.ERROR: () => const Icon(
              Icons.error_outline,
              size: 24,
              color: Colors.redAccent,
            ),
        DialogStatus.INFO: () => const Icon(
              Icons.announcement_outlined,
              size: 24,
              color: Colors.grey,
            ),
        DialogStatus.SUCCESS: () => const Icon(
              Icons.check_circle,
              size: 24,
              color: Colors.green,
            ),
        DialogStatus.WARNING: () => const Icon(
